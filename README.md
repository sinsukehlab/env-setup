...
ところで、WSL2 は、本物の Linux カーネルを仮想マシン上で動作させるなど、WSL1 と全く異なる仕組みで作られている。WSL1 だけでは物足りなくなって、結局ほぼ本物の Linux を搭載するよう大幅な改変が行われたのは、~~[Docker が動かなかったから](https://www.orangeitems.com/entry/2020/05/20/102112)...らしいが、そんな話をしても難しいので、~~あえてこの理由をあげたいと思う。
